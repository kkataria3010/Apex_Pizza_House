...
<h1 class="section-heading" style="margin-top:2rem;margin-bottom:1rem;">Pending Orders</h1>
  ...
  <hr>
    <div>  
      ...
      @if ($order['status']=='pending')
        ...
        <button class="btn btn-primary container dispatchorder" id="{{$order['id']}}">Dispatch</button>
        </div>
      @endif
    </div>
    <hr>
