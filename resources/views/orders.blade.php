...
<h1 class="section-heading" style="margin-top:2rem;margin-bottom:1rem;">Orders</h1>
  ...
  <hr>
    <div>  
      ...
      @if ($order['status']=='pending')
        ...
        <button class="btn btn-primary container cancelorder" id="{{$order['id']}}">Cancel Order</button>
        </div>
      @endif
    </div>
    <hr>
